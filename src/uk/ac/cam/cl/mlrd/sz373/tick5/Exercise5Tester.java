...
public class Exercise5Tester {
	...
	public static void main(String[] args) throws IOException {
		...
		Path sentimentFile = dataDirectory.resolve("review_sentiment.txt");
		// Get the data set.
		...
		Path oldSentFile = testDirectory.resolve("test_sentiment.txt");
		Map<Path, Sentiment> testSet = DataPreparation1.loadSentimentDataset(testDirectory.resolve("reviews"),
				oldSentFile);
		Path newSentFile = newDataDirectory.resolve("review_sentiment.txt");
